...
namespace The_amazing_of_numbers.Model
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="DBUniversity1")]
    ...
    partial void InsertPractiseScore2(PractiseScore2 instance);
    partial void UpdatePractiseScore2(PractiseScore2 instance);
    partial void DeletePractiseScore2(PractiseScore2 instance);
    ...
    partial void DeleteAcademic_Affair(Academic_Affair instance);
		...
		public dbUniversityDataContext() : 
				base(global::The_amazing_of_numbers.Properties.Settings.Default.DBUniversity1ConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<PractiseScore2> PractiseScore2s
		{
			get
			{
				return this.GetTable<PractiseScore2>();
			}
		}
	...
	public partial class Student : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<PractiseScore2> _PractiseScore2s;
    ...
    partial void OnpictureChanged();
		...
		public Student()
		{
			...
			this._PractiseScore2s = new EntitySet<PractiseScore2>(new Action<PractiseScore2>(this.attach_PractiseScore2s), new Action<PractiseScore2>(this.detach_PractiseScore2s));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Student_PractiseScore2", Storage="_PractiseScore2s", ThisKey="id", OtherKey="id")]
		public EntitySet<PractiseScore2> PractiseScore2s
		{
			get
			{
				return this._PractiseScore2s;
			}
			set
			{
				this._PractiseScore2s.Assign(value);
			}
		}
		...
		private void attach_PractiseScore2s(PractiseScore2 entity)
		{
			this.SendPropertyChanging();
			entity.Student = this;
		}
		
		private void detach_PractiseScore2s(PractiseScore2 entity)
		{
			this.SendPropertyChanging();
			entity.Student = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.PractiseScore2")]
	public partial class PractiseScore2 : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void Onlearning_scoreChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Student_PractiseScore2", Storage="_Student", ThisKey="id", OtherKey="id", IsForeignKey=true)]
		public Student Student
		{
			get
			{
			...
			set
			{
							...
							|| (this._Student.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Student.Entity = null;
						previousValue.PractiseScore2s.Remove(this);
					}
					this._Student.Entity = value;
					if ((value != null))
					{
						value.PractiseScore2s.Add(this);
						this._id = value.id;
					}
					else
					{
